...
public class DeliveryTest {
    ...
    void shouldSendForm() {
        ...
        $x("//input[@name='name']").setValue("Олег Краснов");
        $x("//input[@name='phone']").setValue("+79099986632");
    ...
    void shouldSendFormWithChoiceCityAndDate() {
        ...
        $x("//input[@name='name']").setValue("Олег Гончарук");
        $x("//input[@name='phone']").setValue("+79099986631");
        $("[data-test-id='agreement']").click();
        $x("//span[@class='button__text']").click();
